...
class MyLightningModule(pl.LightningModule):
    ...
    def on_train_epoch_end(self):
        ...
        os.makedirs(f'output/train-predictions/epoch-{epoch}', exist_ok=True)
        output_file_path = f'output/train-predictions/epoch-{epoch}/caption-predictions.json'
        ...
        self.log('train_accuracy', results['CIDEr'], on_step=False, on_epoch=True, prog_bar=True, logger=True, sync_dist=True)
    ...
    def on_validation_epoch_end(self):
        ...
        os.makedirs(f'output/validation-predictions/epoch-{epoch}', exist_ok=True)
        output_file_path = f'output/validation-predictions/epoch-{epoch}/caption-predictions.json'
